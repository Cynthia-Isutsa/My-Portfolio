    ...
    <div id='main' className ='bg-black/90 w-full h-screen'>
      <div className='w-full h-screen absolute top-0 left-0 bg-black-30'>
        <div className= 'max-w-[700px] m-auto h-full w-full flex flex-col justify-center lg::items-start items-center'>
          <h1 className = 'text-[#0096A9] sm:text-5xl text-4xl font-bold'>I'm Isutsa Cynthia</h1>
          ...
          <TypeAnimation
             sequence={[
              ...
              speed={50}
              cursor={true}
              style={{ fontSize: '1em', paddingLeft: '5px', color: '#0096A9' }}
              repeat={Infinity}
          />
          </h2>
          <h5 className = 'text-[#77725f] flex sm:text-2xl text-2xl pt-5 flex-col justify-center items-center text-center'>I am a Front-end developer based in Nairobi, Kenya. 
            I have used React, Tailwind, Redux and Next.js to build stunning and scalable web applications that delight users and drive results. 
