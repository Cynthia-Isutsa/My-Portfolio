    ...
    <div className="bg-black/90 flex justify-center items-center">
      <div className=" bg-black/30 mt-40 mb-28">
        <div className="max-w-[700px] m-auto h-full w-full flex flex-col justify-center lg::items-start items-center">
          <h1 className="text-[#fafbe9] sm:text-5xl text-4xl font-bold">
            I'm Isutsa Cynthia
          </h1>
          <h2 className="text-[#899921] flex sm:text-4xl text-3xl pt-5">
            I'm a
            <TypeAnimation
              sequence={[
                "Web Developer",
          ...
          <h5 className="text-gray-400 flex sm:text-2xl text-2xl pt-5 flex-col justify-center text-start">
            I am a Front-end Developer with a passion for transforming complex
            problems into elegant, user-friendly solutions. have gained
