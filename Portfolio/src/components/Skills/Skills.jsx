...
const Skills = () => {
  return (
    <div id='skills' className=' max-w-[1040px] m-auto md:pl-20 p-4 py-16'>
      <h2 className ='text-[#b9af88] sm:text-4xl font-900 text-center'>Skills</h2>
      <p className='text-center p-2 mb-5 sm:text-sm text-[#CBB682]'>My Technical Stack</p>
        ...
        <div className='relative flex flex-col justify-center h-auto w-full shadow-xl shadow-[#001C30] rounded-xl group hover:bg-gradient-to-r from-[#272829] to-[#2C3333]'>
          ...
          <div className='flex flex-row flex-start items-start'>
            <div className='m-7'>
              ...
              <Item title1='Firebase' level1= 'Proficient' />
            </div>
            <div className='m-7'>
              <Item title1='Next.js' level1= 'Proficient' />
            </div>
          </div>
        </div>
