  ...
  return (
    <div className='bg-black/90'>
      ...
      <div className=' m-10  flex md:flex-row flex-col flex-1 justify-center items-center gap-8'>
        ...
        <div className='flex-1'>
          <h1 className='text-[#899921] text-4xl font-semibold mb-4'>Frontend Developer at Pathways Technologies</h1>
          <p className='text-lg text-gray-400'>As a frontend developer at Pathways Technologies, my work involves design, develop, and maintain features for software applications. 
            I manage time tracking, priorities, and deliverables. Debug/troubleshoot applications and determine optimal fix.<br /></p>
